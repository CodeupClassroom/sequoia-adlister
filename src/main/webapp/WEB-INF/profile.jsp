    ...
    <div id="content" class="container">
        <div class="row">
            <div class="col-lg-3 welcome">
                ...
                <a class="btn btn-default center-block" href="/editUser?id=${sessionScope.user.id}"><span
                                ...
                                <div role="tabpanel" class="tab-pane active">
                                    <div class="panel panel-info">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><a href="/showAd?id=${ad.id}"><c:out
                                                    value="${ad.title}"/></a></h3>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <a class="btn btn-default"
                                                           href="/editAd?id=${ad.id}&title=${ad.title}&description=${ad.description}"><span
                                                                class="glyphicon glyphicon-edit"
                                                                aria-hidden="true"></span> Edit Ad</a>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <form id="myform" method="post" action="/deleteAd">
                                                            <input type="hidden" name="id" value=${ad.id}>
                                                            <button id="btn_move_to_the_right" type="submit"
